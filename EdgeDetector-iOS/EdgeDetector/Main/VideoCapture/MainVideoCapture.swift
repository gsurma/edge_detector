...
public protocol VideoCaptureDelegate: class {
    func videoCapture(_ capture: MainVideoCapture, didCaptureVideoFrame: CVPixelBuffer?, timestamp: CMTime)
}

public class MainVideoCapture: NSObject {
...
extension MainVideoCapture: AVCaptureVideoDataOutputSampleBufferDelegate {
